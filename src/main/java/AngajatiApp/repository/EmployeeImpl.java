...
import AngajatiApp.model.AgeSortCriteria;
...
import AngajatiApp.model.SalarySortCriteria;
...
public class EmployeeImpl implements EmployeeRepositoryInterface {
	...
	public boolean addEmployee(Employee employee) {
		employee.setIdEmployee(employeeList.size());
	...
	public List<Employee> getEmployeeByCriteria() {
		...
		Collections.sort(employeeSortedList, new AgeSortCriteria());
		//System.out.println(employeeSortedList);
		Collections.sort(employeeSortedList, new SalarySortCriteria());
		//System.out.println(employeeSortedList);
	...
	public Employee findEmployeeById(int idOldEmployee) {
		for (Employee employee : employeeList) {
			if (employee.getIdEmployee() == idOldEmployee) {
				return employee;
			}
		}
		return null;
